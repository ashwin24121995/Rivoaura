              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  ...
                  <p className="text-slate-700 leading-relaxed mb-4">
                    Elite Squad Sports is owned and operated by <strong>KAVERAMMA COFFEE CURING WORKS PRIVATE LIMITED</strong>, a legally registered Indian private limited company incorporated under the Companies Act, 2013.
                  </p>
          ...
          <div className="space-y-8">
            <div className="bg-slate-800 p-8 rounded-xl border border-slate-700">
              ...
              <p className="text-slate-300 leading-relaxed mb-4">
                <strong>Short answer: We don't.</strong> Elite Squad Sports operates on a <strong>pre-funded model</strong>. We are backed by private investors who believe in the educational and social value of fantasy sports. These investors have provided capital to build and maintain the platform without expecting immediate financial returns.
              </p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-red-800 leading-relaxed mb-4">
                      <strong>Only users who are 18 years of age or older are permitted to use Elite Squad Sports.</strong> This is a strict legal requirement under Indian law. During registration, users must provide their date of birth, and our system automatically rejects accounts for individuals under 18.
                    </p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-orange-800 leading-relaxed mb-4">
                      <strong>Elite Squad Sports is NOT available to residents of the following Indian states:</strong>
                    </p>
      ...
      <section className="py-20 bg-slate-50">
        <div className="container max-w-5xl">
          ...
          <div className="bg-white p-8 rounded-xl border border-slate-200">
            <div className="prose prose-lg max-w-none text-slate-700 leading-relaxed space-y-6">
              <p>
                <strong>There is no real money involved at any stage of the Elite Squad Sports experience.</strong> This is not a marketing claim—it is a fundamental design principle that shapes every aspect of our platform.
              </p>
      ...
      <section className="py-20 bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 text-white">
        <div className="container max-w-4xl text-center">
          ...
          <div className="space-y-6 text-lg text-slate-300 leading-relaxed">
            <p>
              We promise to <strong>always keep Elite Squad Sports 100% free</strong> for core fantasy cricket gameplay. No hidden fees, no paywalls, no bait-and-switch tactics.
            </p>
            <p>
